$(function(){
	...
	$sidebarMenu.click(function(){
		console.log(this)
			console.log($(".select>.jd").eq($(this).index()));
			$("html,body").stop().animate({"scrollTop":$(".select>.jd").eq($(this).index()).offset().top},500);
			console.log($(".select>.jd").eq($(this).index()).offset().top);			
		});
